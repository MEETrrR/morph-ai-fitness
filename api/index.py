...
DB_PATH = os.path.join(os.environ.get("DB_DIR", "/tmp"), "fitness.db")
FREE_TRIAL_DAYS = 3
MONTHLY_PRICE = 19
AI_DAILY_LIMIT = 10
PUSH_SECRET = os.environ.get("PUSH_SECRET") or hmac.new(SECRET_KEY, b"push", hashlib.sha256).hexdigest()
UPLOAD_DIR = os.path.join(os.environ.get("DB_DIR", "/tmp"), "uploads")
...
# Mount static frontend files from project root (for Vercel FastAPI preset)
